...
class OpportunityRegisterForm {
  /**
   * Inits the OpportunityRegisterForm component with handlers.
   * @constructor
   * @param {Element} form
   */
  constructor(form) {
    ...
    this.contentTypeId = 'opportunity';
...
export { OpportunityRegisterForm };
